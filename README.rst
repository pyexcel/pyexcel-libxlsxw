...
**** is a tiny wrapper library to write data in xlsx and xlsm fromat using xlsxwriter. You are likely to use it with `pyexcel <https://github.com/pyexcel/pyexcel>`__.
...
Here's the sample code to write a dictionary to an  file:

.. code-block:: python

    >>> from pyexcel_ import save_data
